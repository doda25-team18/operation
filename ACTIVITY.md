...
- Fedor
  ...
  THis week I worked on A4 - specifically, the Continuous Experimentation part. I have written the JavaScript/Python/CSS code for the new feature (update: this code has been deleted alongside the PR, as the related code was flawed and replaced by code in https://github.com/doda25-team18/app/pull/7) and created documentation for it. I am also working on the metrics for said feature.
